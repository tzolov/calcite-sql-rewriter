...
CREATE TABLE calcite_sql_rewriter_integration_test.non_journalled (
...
INSERT INTO calcite_sql_rewriter_integration_test.emps_journal (empid, deptno, first_name, last_name, version_number)
