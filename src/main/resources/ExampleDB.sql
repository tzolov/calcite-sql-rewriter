...
INSERT INTO hr.emps_journal (empid,deptno,first_name,last_name) VALUES (1,1,'Peter','Pan'),(2,1,'Ian','Bibian'),(3,2,'Victor','Strugatski'),(4,2,'Stan','Ban'),(5,2,'Dimitar','Gergov'),(6,4,'Ivan','Baraban');
...
INSERT INTO hr.depts_journal (deptno, version_number, department_name)
  ...
  SELECT deptno, version_number + interval '1 hour', 'Name2'
    FROM link_last
    WHERE subsequent_version_number IS NULL
        AND version_number = last_version_number;
